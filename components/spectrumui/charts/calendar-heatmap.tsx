...
export function CalendarHeatmap({
  ...
  return (
    ...
    >
      ...
      <div className={cn('flex flex-wrap items-end justify-between gap-x-4 gap-y-2', compact ? 'mb-2' : 'mb-3')}>
        <div>
          <p className={cn('font-mono text-[13px] font-medium tracking-wide', compact ? 'text-white' : 'text-neutral-950 dark:text-white')}>
